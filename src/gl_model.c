...
// TODO: Give these functions a header
extern void GL_SubdivideSurface (msurface_t *fa); // defined in gl_warp.c
extern void GL_MakeAliasModelDisplayLists (model_t *m, aliashdr_t *hdr); // gl_mesh.c
